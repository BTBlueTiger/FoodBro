...
val md_theme_light_tertiary = Color(0xFF0059C7)
...
object Color {
    ...
    val Green = Color(0xFF317300)
    val Yellow = Color(0xFFFCE400)
    val light_Green = Color(0xFF2E6C00)
    val light_onGreen = Color(0xFFFFFFFF)
    val light_GreenContainer = Color(0xFFABF67D)
    val light_onGreenContainer = Color(0xFF092100)
    val dark_Green = Color(0xFF90D964)
    val dark_onGreen = Color(0xFF143800)
    val dark_GreenContainer = Color(0xFF215100)
    val dark_onGreenContainer = Color(0xFFABF67D)
    val light_Yellow = Color(0xFF6A5F00)
    val light_onYellow = Color(0xFFFFFFFF)
    val light_YellowContainer = Color(0xFFFCE401)
    val light_onYellowContainer = Color(0xFF201C00)
    val dark_Yellow = Color(0xFFDDC800)
    val dark_onYellow = Color(0xFF373100)
    val dark_YellowContainer = Color(0xFF504700)
    val dark_onYellowContainer = Color(0xFFFCE401)
}
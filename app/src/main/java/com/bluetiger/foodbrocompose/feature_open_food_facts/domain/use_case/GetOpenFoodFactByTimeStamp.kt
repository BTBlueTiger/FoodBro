...
class GetOpenFoodFactByTimeStamp(
    private val repository: OpenFoodFactsRepository
) {
    suspend operator fun invoke(timeStamp: Long): OpenFoodFactsData {
        return repository.getOpenFoodFactResponseByTimeStamp(timeStamp)
    }
}